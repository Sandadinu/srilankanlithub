...
<div class="header-actions">
    <h2>Add Critical Essay</h2>
    <a href="/admin?key={{ request()->query('key') }}" class="btn btn-outline">&larr; Back to Dashboard</a>
</div>

<div class="card" style="max-width: 800px;">
    <form action="/admin/essays/store?key={{ request()->query('key') }}" method="POST">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" id="writer_name" name="writer_name" required value="{{ old('writer_name') }}">
        </div>
